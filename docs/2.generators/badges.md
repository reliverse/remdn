...
<!-- remdn:example generator=badges color=yellow license name=defu codecov bundlephobia packagephobia -->

### Input

    <!-- remdn:badges color="yellow" license name="defu" codecov bundlephobia packagephobia -->
    <!-- /remdn -->
...
### Output
    ...
    [![codecov](https://img.shields.io/codecov/c/gh/reliverse/remdn?color=yellow)](https://codecov.io/gh/reliverse/remdn)
    [![license](https://img.shields.io/github/license/reliverse/remdn?color=yellow)](https://github.com/reliverse/remdn/blob/main/LICENSE)
